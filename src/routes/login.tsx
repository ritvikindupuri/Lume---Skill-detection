...
export const Route = createFileRoute("/login")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Sign in to your Attest company security workspace." },
    { property: "og:title", content: "Sign in — Attest" },
...
function LoginPage() {
  return (
    <main className="flex min-h-screen flex-col bg-background px-6">
      <header className="mx-auto flex h-16 w-full max-w-6xl items-center"><Link to="/" aria-label="Attest home"><Logo /></Link></header>
